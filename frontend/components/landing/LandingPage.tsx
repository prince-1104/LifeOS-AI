    ...
    <div className="min-h-screen bg-[#0e0716] text-white selection:bg-[#FF9ECA] selection:text-[#0e0716] font-sans pb-0">
      ...
      <main className="pt-40 pb-20 px-6 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative justify-self-center lg:justify-self-end mt-12 lg:mt-0 w-full max-w-[280px]">
             <div className="group relative w-full aspect-[5/3] rounded-3xl overflow-hidden flex items-center justify-center cursor-pointer shadow-2xl">
